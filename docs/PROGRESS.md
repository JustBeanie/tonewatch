...
- [x] **M17.5** Web UI: incident card, dashboard CAD panel, agency recent incidents. — direct to main — incident card, live CAD badge, dashboard panel, agency incidents, CAD feed settings, unmatched agencies
